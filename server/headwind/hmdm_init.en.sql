...
-- passwordReset=false: admin password is set by KOMMS setup_server.sh on first start.
-- Do NOT set passwordResetToken here — that would trigger the forced-reset UI flow.
UPDATE users SET email='_ADMIN_EMAIL_', passwordReset=false WHERE id=1;
